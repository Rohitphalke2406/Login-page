...
const SignUp = () => {
  ...
  return (
    <div>
      ...
      <form
        onSubmit={signUp}
        className="mt-4 border-2 p-4 m-4 flex flex-col justify-center items-center gap-6 max-w-md w-full mx-auto rounded-lg bg-slate-100"
      >
        ...
        <button
          type="submit"
          className="bg-blue-300 text-white rounded-3xl p-4  "
        >
          Sign Up
        </button>
        <p>
